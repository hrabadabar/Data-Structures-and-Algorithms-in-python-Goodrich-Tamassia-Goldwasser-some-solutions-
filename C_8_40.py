...
class LinkedBinaryTree(BinaryTree):
  ...
  def _add_left(self, p, e):
    ...
    self._size += 1
    node._left = self._Node(e, node,self._sentinel,self._sentinel)                  # node is its parent
    return self._make_position(node._left)
  ...
  def _add_right(self, p, e):
    ...
    self._size += 1
    node._right = self._Node(e, node,self._sentinel,self._sentinel)                 # node is its parent
    return self._make_position(node._right)
